...
/**
 * Pushes a single challange(aka. flag[aka. level]) into the template file
 * @param challange Object
 */
...
exports = module.exports = function productReviews () {
  return function (req, res, next) {
    // Load the Basic fbctf im/export template in which the challanges will get inserted
    template = require('../data/fbctfImportTemplate')
    // Load a List of all Countries and sort them into categories based on the size and deveopment
    initCountryList()
    ...
    //Downlaod the generated File as game.json
